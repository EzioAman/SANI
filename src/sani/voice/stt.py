"""Speech-to-Text (STT) Subsystem utilizing Gemini Multimodal Audio Processing."""
...
class GeminiSTTProvider:
    """Transcribes audio bytes to text using Gemini audio capabilities via Chat API."""
    ...
    def speech_to_text(self, audio_bytes: bytes, mime_type: str = "audio/wav") -> str:
        """Convert recorded audio bytes into transcribed text string."""
        ...
        try:
            ...
            # Use Chat API to eliminate AFC warning
