...
MEMORY_FILES = {
    ...
    "bhaisasur": os.path.join(BASE_DIR, "memory_bhaisasur.json"),
    "qwerty": os.path.join(BASE_DIR, "memory_qwerty.json"),
}
MODEL_PATH = "E:/SANI AI/Mistral/mistral-7b-instruct-v0.1.Q4_0.gguf"
...
admin_users = {"morfit2409": 3, "bhaisasur": 2, "qwerty": 1}  # Priority levels
